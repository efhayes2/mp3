...
FHIR.oauth2.ready().then(function(client) {
  ...
  function addWeightAnnotation() {
    ...
    // const dateString = (new Date(new Date().toString().split('GMT')[0]+' UTC').toISOString());
    const dateString = (new Date(new Date().getTime() - new Date().getTimezoneOffset() * 60000).toISOString());

    var txt = document.getElementById("annotation").value;

    var authorString = "Updated by R. Buckminster Fuller<br>"
    var annotation = txt + "<br>" + authorString + "   " + dateString;
